...
contract("DxMarketMaker", async accounts => {
  ...
  xit("should allow getting amount of KNC to start next auction", async () => {
    ...
    dbg(
      `new auction threshold is ${auctionThreshold} USD -> ${auctionThreholdKnc}`
    )
  ...
  it(
    "should allow getting amount of KNC to start next auction, after some other user already posted sell order"
  )
